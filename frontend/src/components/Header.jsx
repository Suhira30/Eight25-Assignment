  ...
  return (
    <header className="bg-surface border-b border-outline-variant flex justify-between items-center px-margin-desktop w-full max-w-container-max mx-auto h-16 sticky top-0 z-50">
      ...
      <div className="flex items-center gap-stack-md">
        <button className="px-4 py-2 bg-primary-container text-on-primary font-bold rounded-lg shadow-sm hover:brightness-110 active:scale-95 transition-all flex items-center gap-2 text-label-sm font-label-sm">
