export default function Footer() {
  return (
    <footer className="bg-surface-container-low py-stack-lg">
      <div className="max-w-container-max mx-auto px-margin-desktop flex flex-col md:flex-row justify-between items-center text-on-surface-variant text-label-sm font-label-sm">
        <p>© 2024 SEO Insight Pro. All rights reserved.</p>
